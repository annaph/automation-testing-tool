...
import org.cartagena.tool.core.model.StepTestUtil.{MyStepException, MyRouterStep => S2, MyRouterStepToFail => S2ToFail, MyShapelessStep1 => S1, MyShapelessStep2 => S3, MyShapelessStep2ToFail => S3ToFail, MyShapelessStepToFail1 => S1ToFail}
