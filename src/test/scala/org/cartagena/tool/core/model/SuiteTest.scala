...
import org.cartagena.tool.core.model.StepTestStructures.{MyCleanupStep => CleanupStep, MyCleanupStepToFail => CleanupStepToFail, MySetupStep => SetupStep, MySetupStepToFail => SetupStepToFail, MyShapelessStep => S1, MyShapelessStep2 => S2, MyShapelessStep2ToFail => S2ToFail, MyShapelessStep3 => S3, MyShapelessStep3ToFail => S3ToFail, MyShapelessStepToFail => S1ToFail}
