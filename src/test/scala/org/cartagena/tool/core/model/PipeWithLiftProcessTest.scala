...
class PipeWithLiftProcessTest extends FlatSpec with Matchers {
  ...
  "count |> lift" should "create process to count number of processed characters and then convert counters to " +
    "characters" in {
    // given
